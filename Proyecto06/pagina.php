...
class pagina{
	...
	*/
	function setPagMenu(){
		...
		if(isset($_SESSION["usuario"])){
			$this->menu=array("INICIO"=>array("url"=>"index.php"),"PERFIL"=>array("url"=>"perfil.php"),"LUGARES"=>array("url"=>"lugares.php"),"FOTOS"=>array("url"=>"fotos.php"),"CONTACTO"=>array("url"=>"contacto.php"));
		}else{
	...
	*/
	function setContent($texto,$esTabla){
		...
		if(!$this->seguridad->comprobarUsuario() && end(explode("/",$_SERVER["PHP_SELF"]))!="error.php"){
